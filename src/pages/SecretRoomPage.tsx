    ...
    <div className="max-w-6xl mx-auto space-y-12">
      ...
      >
        <div>
          <a href="/" className="hover:underline">
            หน้าแรก
          </a>{" "}/ <span className="text-primary dark:text-accent" aria-current="page">ห้องลับ</span>
        </div>
        <button
          onClick={() => {
            logout();
      ...
      <section className="bg-white dark:bg-gray-800 shadow-xl rounded-2xl p-4 sm:p-6 space-y-4">
        ...
        <div className="text-right space-x-2">
          <button type="button" className="btn btn-sm" onClick={() => handleDownload(salaryRef, "png")}>
            Download PNG
          </button>
          <button type="button" className="btn btn-sm btn-outline" onClick={() => handleDownload(salaryRef, "pdf")}>
            Download PDF
          </button>
        </div>
      </section>
      ...
      <section className="bg-white dark:bg-gray-800 shadow-xl rounded-2xl p-4 sm:p-6 space-y-4">
        ...
        <div className="text-right space-x-2">
          <button type="button" className="btn btn-sm" onClick={() => handleDownload(businessRef, "png")}>
            Download PNG
          </button>
          <button type="button" className="btn btn-sm btn-outline" onClick={() => handleDownload(businessRef, "pdf")}>
            Download PDF
          </button>
        </div>
      </section>
