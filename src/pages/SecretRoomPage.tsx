      ...
      {isUnlocked && (
        <>
          <section className="bg-white dark:bg-gray-800 rounded-xl shadow p-6 space-y-4">
            ...
            <div ref={businessRef} className="border rounded overflow-auto flex justify-center bg-white dark:bg-gray-900">
              <iframe
          ...
          <section className="bg-white dark:bg-gray-800 rounded-xl shadow p-6 space-y-4">
            ...
            <div ref={salaryRef} className="border rounded overflow-auto flex justify-center bg-white dark:bg-gray-900">
              <iframe
