...
const SecretRoomPage: React.FC = () => {
  ...
  // ตรวจสอบสถานะ session และเวลาหมดอายุ
  useEffect(() => {
    if (!currentUser) {
      navigate("/login");
      return;
  ...
  // ดาวน์โหลดเอกสารจาก <div> เป็น PNG หรือ PDF
          ...
          {isUnlocked && (
            <>
              ...
              <section className="bg-white dark:bg-gray-800 rounded-xl shadow p-6 space-y-4">
                ...
                <div ref={salaryRef} className="border rounded overflow-auto flex justify-center">
                  <iframe
                    src="/salary-certificate.html"
                    width="794"
                    height="1123"
                    className="w-[794px] max-w-full"
              ...
              <section className="bg-white dark:bg-gray-800 rounded-xl shadow p-6 space-y-4">
                ...
                <div ref={businessRef} className="border rounded overflow-auto flex justify-center">
                  <iframe
