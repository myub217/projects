...
const DocumentSummaryPanel: React.FC<DocumentSummaryPanelProps> = ({ report }) => {
  ...
  return (
    <section className="mb-8 grid gap-4 sm:grid-cols-2" aria-label="รายงานสรุปผลการดำเนินงานเอกสาร">
      <div
        ...
        <ul className="list-inside list-disc space-y-1 text-sm text-gray-700 dark:text-gray-300">
          <li>
            ...
            {documentCount > 0 ? (
              ...
              <span className="italic text-gray-500">ไม่มีข้อมูล</span>
            )}
          </li>
          <li>
          ...
          <li>
            สถานะล่าสุดของเอกสาร: <span className="font-medium">{lastDocumentStatus}</span>
          </li>
        </ul>
      </div>
    </section>
