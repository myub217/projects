          ...
          >
            ...
            <div className="mt-6 flex justify-end gap-2">
              <button
                type="button"
                onClick={() => setSelectedService(null)}
                className="rounded bg-gray-300 px-4 py-2 text-sm hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-500"
              >
                ปิด
              </button>
              <button
                ...
                className="rounded bg-primary px-4 py-2 text-sm text-white hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary"
              >
                ยืนยัน
              </button>
            </div>
