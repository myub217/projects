        ...
        <div className="flex justify-end gap-3">
          <button
            ...
            className={clsx(
              ...
              loading ? 'cursor-not-allowed opacity-50' : 'hover:bg-gray-100 dark:hover:bg-gray-800'
            )}
            onClick={onCancel}
            disabled={loading}
            ref={cancelButtonRef}
          ...
          <button
            type="button"
            className={clsx('btn btn-primary btn-sm', loading ? 'loading cursor-not-allowed' : '')}
            onClick={onConfirm}
            disabled={loading}
