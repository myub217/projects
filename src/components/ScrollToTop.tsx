...
const LineButton: React.FC<LineButtonProps> = ({ lineUrl }) => {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 p-3 rounded-full shadow-lg transition-transform duration-300 bg-green-500 hover:bg-green-600 text-white dark:bg-green-600 dark:hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-400"
    >
      <svg
        className="w-6 h-6"
        viewBox="0 0 512 512"
